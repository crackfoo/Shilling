...
uint256 hashGenesisBlock("0xd9a8e6394a6dfeb793ca4ecb88ddf748fffdc5015df3ceb02f6b150e22c17dee");
...
{
    // Shilling: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetSpacing = 6.133 * 60;
...
{
	static const int64	BlocksTargetSpacing			= 6.133 * 60;
	unsigned int		TimeDaySeconds				= 60 * 60 * 24;
	int64				PastSecondsMin				= TimeDaySeconds * 6.133 * 0.1;
	int64				PastSecondsMax				= TimeDaySeconds * 6.133 * 2.8;
...
{
    // Shilling: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1469132576;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2069444;
	    ...
	    //assert(block.hashMerkleRoot == uint256("0x35e6a0e897ed76cd5f08b75d128fb7c99aec7cdd297b96c21dc6671d2034c953"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd8, 0xcf, 0xaa, 0xec };
