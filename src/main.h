...
static const int64 MAX_MONEY = 30000000 * COIN; // Shilling: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 6.133) / 250; // Shilling: Priority cutoff is 2 Shilling day / 250 bytes.
    }
